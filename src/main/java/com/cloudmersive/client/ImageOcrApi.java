...
public class ImageOcrApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call imageOcrPhotoWordsWithLocationCall(File imageFile, String language, String preprocessing, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call imageOcrPhotoWordsWithLocationValidateBeforeCall(File imageFile, String language, String preprocessing, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = imageOcrPhotoWordsWithLocationCall(imageFile, language, preprocessing, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PhotoToWordsWithLocationResult imageOcrPhotoWordsWithLocation(File imageFile, String language, String preprocessing) throws ApiException {
        ApiResponse<PhotoToWordsWithLocationResult> resp = imageOcrPhotoWordsWithLocationWithHttpInfo(imageFile, language, preprocessing);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PhotoToWordsWithLocationResult> imageOcrPhotoWordsWithLocationWithHttpInfo(File imageFile, String language, String preprocessing) throws ApiException {
        com.squareup.okhttp.Call call = imageOcrPhotoWordsWithLocationValidateBeforeCall(imageFile, language, preprocessing, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call imageOcrPhotoWordsWithLocationAsync(File imageFile, String language, String preprocessing, final ApiCallback<PhotoToWordsWithLocationResult> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = imageOcrPhotoWordsWithLocationValidateBeforeCall(imageFile, language, preprocessing, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PhotoToWordsWithLocationResult>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
