...
public class ConvertDocumentApi {
    ...
    /**
     * Build call for convertDocumentDocxToOdt
     * @param inputFile Input file to perform the operation on. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call convertDocumentDocxToOdtCall(File inputFile, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/convert/docx/to/odt";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call convertDocumentDocxToOdtValidateBeforeCall(File inputFile, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'inputFile' is set
        if (inputFile == null) {
            throw new ApiException("Missing the required parameter 'inputFile' when calling convertDocumentDocxToOdt(Async)");
        }
        

        com.squareup.okhttp.Call call = convertDocumentDocxToOdtCall(inputFile, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public byte[] convertDocumentDocxToOdt(File inputFile) throws ApiException {
        ApiResponse<byte[]> resp = convertDocumentDocxToOdtWithHttpInfo(inputFile);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<byte[]> convertDocumentDocxToOdtWithHttpInfo(File inputFile) throws ApiException {
        com.squareup.okhttp.Call call = convertDocumentDocxToOdtValidateBeforeCall(inputFile, null, null);
        Type localVarReturnType = new TypeToken<byte[]>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Convert Word DOCX Document to ODT (asynchronously)
     * Convert Office Word Documents (docx) to ODT format
     * @param inputFile Input file to perform the operation on. (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call convertDocumentDocxToOdtAsync(File inputFile, final ApiCallback<byte[]> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = convertDocumentDocxToOdtValidateBeforeCall(inputFile, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<byte[]>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public com.squareup.okhttp.Call convertDocumentPdfToPngArrayDirectCall(File inputFile, Integer dpi, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/convert/pdf/to/png/direct";
    ...
    private com.squareup.okhttp.Call convertDocumentPdfToPngArrayDirectValidateBeforeCall(File inputFile, Integer dpi, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'inputFile' is set
        if (inputFile == null) {
            throw new ApiException("Missing the required parameter 'inputFile' when calling convertDocumentPdfToPngArrayDirect(Async)");
        }
    ...
    /**
     * Build call for convertDocumentTxtToPdf
     * @param inputFile Input file to perform the operation on. (required)
     * @param scaleFactor Optional: Set to 100 to scale at 100%, set to 50% to scale down to 50% scale, set to 200% to scale up to 200% scale, etc.  Default is 100%. Maximum is 1000%. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call convertDocumentTxtToPdfCall(File inputFile, Integer scaleFactor, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/convert/txt/to/pdf";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call convertDocumentTxtToPdfValidateBeforeCall(File inputFile, Integer scaleFactor, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'inputFile' is set
        if (inputFile == null) {
            throw new ApiException("Missing the required parameter 'inputFile' when calling convertDocumentTxtToPdf(Async)");
        }
        

        com.squareup.okhttp.Call call = convertDocumentTxtToPdfCall(inputFile, scaleFactor, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public byte[] convertDocumentTxtToPdf(File inputFile, Integer scaleFactor) throws ApiException {
        ApiResponse<byte[]> resp = convertDocumentTxtToPdfWithHttpInfo(inputFile, scaleFactor);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<byte[]> convertDocumentTxtToPdfWithHttpInfo(File inputFile, Integer scaleFactor) throws ApiException {
        com.squareup.okhttp.Call call = convertDocumentTxtToPdfValidateBeforeCall(inputFile, scaleFactor, null, null);
        Type localVarReturnType = new TypeToken<byte[]>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Convert TXT text file to PDF Document (asynchronously)
     * Convert simple text files to PDF.
     * @param inputFile Input file to perform the operation on. (required)
     * @param scaleFactor Optional: Set to 100 to scale at 100%, set to 50% to scale down to 50% scale, set to 200% to scale up to 200% scale, etc.  Default is 100%. Maximum is 1000%. (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call convertDocumentTxtToPdfAsync(File inputFile, Integer scaleFactor, final ApiCallback<byte[]> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = convertDocumentTxtToPdfValidateBeforeCall(inputFile, scaleFactor, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<byte[]>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
