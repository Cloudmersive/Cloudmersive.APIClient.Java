...
import com.cloudmersive.client.invoker.auth.OAuth.AccessTokenListener;
import com.cloudmersive.client.invoker.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("Apikey".equals(authName)) {
        auth = new ApiKeyAuth("header", "Apikey");
      } else {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://api.cloudmersive.com";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
