...
public interface ConvertImageApi {
  /**
  ...
  Call<byte[]> convertImageImageFormatConvert(
    @retrofit2.http.Path("format1") String format1, @retrofit2.http.Path("format2") String format2, @retrofit2.http.Part("inputFile\"; filename=\"inputFile") RequestBody inputFile
  );
