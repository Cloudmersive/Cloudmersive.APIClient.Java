...
public class LanguageTranslationApi {
    ...
    /**
     * Build call for languageTranslationHtmlTranslate
     ...
     */
    public com.squareup.okhttp.Call languageTranslationHtmlTranslateCall(LanguageHtmlTranslationRequest input, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = input;

        // create path and map variables
        String localVarPath = "/nlp-v2/translate/language/html";
    ...
    private com.squareup.okhttp.Call languageTranslationHtmlTranslateValidateBeforeCall(LanguageHtmlTranslationRequest input, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'input' is set
        if (input == null) {
            throw new ApiException("Missing the required parameter 'input' when calling languageTranslationHtmlTranslate(Async)");
        }
        

        com.squareup.okhttp.Call call = languageTranslationHtmlTranslateCall(input, progressListener, progressRequestListener);
        return call;
     ...
     */
    public LanguageHtmlTranslationResponse languageTranslationHtmlTranslate(LanguageHtmlTranslationRequest input) throws ApiException {
        ApiResponse<LanguageHtmlTranslationResponse> resp = languageTranslationHtmlTranslateWithHttpInfo(input);
        return resp.getData();
    }
     ...
     * Automatically translates input text in German to output text in English using advanced Deep Learning and Neural NLP.  Consumes 1-2 API calls per input sentence.
     * @param input Input translation request (required)
     * @return ApiResponse&lt;LanguageHtmlTranslationResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<LanguageHtmlTranslationResponse> languageTranslationHtmlTranslateWithHttpInfo(LanguageHtmlTranslationRequest input) throws ApiException {
        com.squareup.okhttp.Call call = languageTranslationHtmlTranslateValidateBeforeCall(input, null, null);
        Type localVarReturnType = new TypeToken<LanguageHtmlTranslationResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Translate HTML with Deep Learning AI (asynchronously)
     * Automatically translates input text in German to output text in English using advanced Deep Learning and Neural NLP.  Consumes 1-2 API calls per input sentence.
     * @param input Input translation request (required)
     ...
     */
    public com.squareup.okhttp.Call languageTranslationHtmlTranslateAsync(LanguageHtmlTranslationRequest input, final ApiCallback<LanguageHtmlTranslationResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = languageTranslationHtmlTranslateValidateBeforeCall(input, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<LanguageHtmlTranslationResponse>(){}.getType();
