...
public class EditDocumentApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call editDocumentDocxAcceptAllTrackChangesCall(File inputFile, Boolean autorepair, Boolean changeOutlines, Boolean headersAndFooters, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call editDocumentDocxAcceptAllTrackChangesValidateBeforeCall(File inputFile, Boolean autorepair, Boolean changeOutlines, Boolean headersAndFooters, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = editDocumentDocxAcceptAllTrackChangesCall(inputFile, autorepair, changeOutlines, headersAndFooters, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public byte[] editDocumentDocxAcceptAllTrackChanges(File inputFile, Boolean autorepair, Boolean changeOutlines, Boolean headersAndFooters) throws ApiException {
        ApiResponse<byte[]> resp = editDocumentDocxAcceptAllTrackChangesWithHttpInfo(inputFile, autorepair, changeOutlines, headersAndFooters);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<byte[]> editDocumentDocxAcceptAllTrackChangesWithHttpInfo(File inputFile, Boolean autorepair, Boolean changeOutlines, Boolean headersAndFooters) throws ApiException {
        com.squareup.okhttp.Call call = editDocumentDocxAcceptAllTrackChangesValidateBeforeCall(inputFile, autorepair, changeOutlines, headersAndFooters, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call editDocumentDocxAcceptAllTrackChangesAsync(File inputFile, Boolean autorepair, Boolean changeOutlines, Boolean headersAndFooters, final ApiCallback<byte[]> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = editDocumentDocxAcceptAllTrackChangesValidateBeforeCall(inputFile, autorepair, changeOutlines, headersAndFooters, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<byte[]>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
