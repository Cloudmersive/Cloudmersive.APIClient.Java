...
public class ConvertDataApi {
     ...
     */
    public Object convertDataCsvToJson(File inputFile) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/convert/csv/to/json").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Object convertDataXmlToJson() throws RestClientException {
        Object postBody = null;
        
        String path = UriComponentsBuilder.fromPath("/convert/xml/to/json").build().toUriString();
