...
> ImageToLinesWithLocationResult imageOcrImageLinesWithLocation(imageFile, language)
...
> ImageToWordsWithLocationResult imageOcrImageWordsWithLocation(imageFile, language)
